(function () {
  ...
  function ruleBlock(r) {
    ...
    return '<article class="tile" id="' + esc(r.id) + '"><div><a class="cite" href="' + esc(r.id) + '.html">' + esc(r.citation) + '</a> · this section only</div><h2>' + esc(r.title) + "</h2><p>" + esc(r.summary) + '</p><ul class="steps">' + lis + '</ul><p><a class="btn" href="' + esc(r.id) + '.html">Open ' + esc(r.citation) + "</a></p></article>";
  }
